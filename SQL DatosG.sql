-- -----------------------------------------------------
-- Base de Datos para la Evaluación del Desempeño de Trabajadores
-- -----------------------------------------------------
...
-- -----------------------------------------------------
IF NOT EXISTS (SELECT * FROM sysobjects WHERE name = 'Evaluadores' AND xtype = 'U')
BEGIN
...
-- Tabla de Criterios
-- -----------------------------------------------------
IF NOT EXISTS (SELECT * FROM sysobjects WHERE name = 'Criterios' AND xtype = 'U')
BEGIN
...
-- -----------------------------------------------------
IF NOT EXISTS (SELECT * FROM sysobjects WHERE name = 'CriteriosEvaluados' AND xtype = 'U')
BEGIN
